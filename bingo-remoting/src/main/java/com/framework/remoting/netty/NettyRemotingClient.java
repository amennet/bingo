 ...
 */
package com.framework.remoting.netty;
...
import com.framework.remoting.InvokeCallback;
import com.framework.remoting.RPCHook;
...
public class NettyRemotingClient extends NettyRemotingAbstract implements RemotingClient {
    ...
    private IProcessor shutdownProcessor;
    ...
    public void shutdown() {
        ...
        if (this.shutdownProcessor != null) {
            this.shutdownProcessor.processor();;
        }

    }

    public void registerShutdownProcessor(IProcessor iProcessor) {
        this.shutdownProcessor = iProcessor;
    }
