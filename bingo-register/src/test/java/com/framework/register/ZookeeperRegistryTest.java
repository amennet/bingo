...
import com.framework.register.support.command.CommandListener;
import com.framework.register.support.command.ServiceListener;
import com.framework.register.zookeeper.ZkNodeType;
import com.framework.register.support.ZookeeperRegistry;
...
public class ZookeeperRegistryTest {
    ...
    public void setUp() throws Exception {
        ...
        clientUrl = new URL(Constants.PROTOCOL_MOTAN, "127.0.0.1", 0, service);
        clientUrl.addParameter("group", "aaa");

        serviceUrl = new URL(Constants.PROTOCOL_MOTAN, "127.0.0.1", 8001, service);
    ...
    public void tearDown() throws Exception {
        zkClient.deleteRecursive(Constants.ZOOKEEPER_REGISTRY_NAMESPACE);
        zookeeper = null;
    }
