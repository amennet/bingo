...
public class GameChannelInfo {
    ...
    public GameChannelInfo(Channel channel) {
        this(channel, null, null, 0);
    }

    public GameChannelInfo(Channel channel, String topic, LanguageCode language, int version) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        GameChannelInfo other = (GameChannelInfo) obj;
        if (channel == null) {
