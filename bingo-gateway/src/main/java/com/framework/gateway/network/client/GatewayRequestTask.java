...
public class GatewayRequestTask implements Runnable {
    ...
    private final NetMessage request;
    private boolean stopRun = false;

    public GatewayRequestTask(final Runnable runnable, final Channel channel, final NetMessage request) {
    ...
    public boolean equals(final Object o) {
        if (this == o)
            return true;
        if (!(o instanceof GatewayRequestTask))
            return false;

        final GatewayRequestTask that = (GatewayRequestTask) o;
